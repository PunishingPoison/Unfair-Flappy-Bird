...
import VisualChaosSystem from './lib/visual-chaos';
...
export default class Game extends ParentClass {
  ...
  public visualChaos: VisualChaosSystem;
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.state = 'intro';
    this.bgPause = false;
    this.visualChaos = new VisualChaosSystem(canvas);
  ...
  public Resize({ width, height }: IDimension): void {
    ...
    // Resize visual chaos system
    this.visualChaos.resize(width, height);
  }
  ...
  public Display(): void {
    ...
    // Apply visual chaos effects (post-processing)
    this.visualChaos.applyChaos(this.context);
  }
