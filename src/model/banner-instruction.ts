...
export default class BannerInstruction extends ParentClass {
  ...
  public Display(context: CanvasRenderingContext2D): void {
    ...
    // Draw "Unfair" text above Get Ready banner
    const unfairFontSize = this.canvasSize.width * 0.1;
    context.font = `bold ${unfairFontSize}px monospace`;
    context.textAlign = 'center';
    context.fillStyle = '#FF0000';
    context.shadowColor = '#8B0000';
    context.shadowBlur = 4;
    context.fillText('Unfair', this.canvasSize.width * 0.5, this.getReadyImage.position.y - unfairFontSize * 0.5);
